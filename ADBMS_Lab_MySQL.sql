...
-- =============================================================
-- EXPERIMENT 4: DDL Operations - ALTER, DESCRIBE, TRUNCATE, DROP
-- =============================================================
...
-- =============================================================
-- EXPERIMENT 5: SELECT Queries on Employees Table
-- =============================================================
...
-- =============================================================
-- EXPERIMENT 6: GROUP BY, Aggregate Functions, Date Functions
-- =============================================================
...
-- =============================================================
-- EXPERIMENT 7: Client_master - DML + Column Alias + RENAME
-- =============================================================
...
-- =============================================================
-- EXPERIMENT 9: Calculated Columns - GrossPay, NetPay
-- =============================================================
...
-- =============================================================
-- EXPERIMENT 10: DDL - RENAME TABLE, ADD/RENAME/MODIFY/DROP Column
-- =============================================================
...
-- =============================================================
-- EXPERIMENT 11: Advanced SELECT Queries on Employee Table
-- =============================================================
...
-- =============================================================
-- EXPERIMENT 12: Subqueries on Employee Table
-- =============================================================
...
-- =============================================================
-- EXPERIMENT 13: Multi-table JOIN Queries
-- =============================================================
...
-- =============================================================
-- EXPERIMENT 14: Salesmen Table - BETWEEN, IN, LIKE
-- =============================================================
...
-- =============================================================
-- EXPERIMENT 15: Sailors, Boats, Reserves - JOIN & Subqueries
-- =============================================================
